...
// ObjectTracker is the highest-level class in the tracking/pp.facerecognizer.detection framework.
// It handles basic image processing, keypoint pp.facerecognizer.detection, keypoint tracking,
// object tracking, and object pp.facerecognizer.detection/relocalization.
class ObjectTracker {
 public:
  ...
  // Does all image processing, keypoint pp.facerecognizer.detection, and object
  // tracking/pp.facerecognizer.detection for registered objects.
