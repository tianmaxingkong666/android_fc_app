...
class KeypointDetector {
 ...
 private:
  ...
  // Scratch memory for keypoint candidacy pp.facerecognizer.detection and non-max suppression.
  ...
  // Keypoint pp.facerecognizer.detection is staggered for performance reasons. Every four frames
