...
// Represents a potential pp.facerecognizer.detection of a specific ObjectExemplar and Descriptor
...
class ObjectDetectorBase {
 public:
  ...
  // Main entry point into the pp.facerecognizer.detection algorithm.
