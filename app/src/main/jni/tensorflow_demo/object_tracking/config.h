...
// Struct that can be used to more richly store the results of a pp.facerecognizer.detection
...
// Keypoint pp.facerecognizer.detection.
...
// The number of pp.facerecognizer.detection failures allowed before an object goes invisible.
...
// examples for pp.facerecognizer.detection to be valid.
