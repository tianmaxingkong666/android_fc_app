...
// It provides the last known position and number of recent pp.facerecognizer.detection failures,
...
class TrackedObject {
 public:
  ...
  // itself based on where the pp.facerecognizer.detection occurred.
  ...
  // Called when there's no pp.facerecognizer.detection of the tracked object. This will cause
